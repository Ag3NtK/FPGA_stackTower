...
architecture Behavioral of ruta_datos is
    ...
    alias enable_divisor: std_logic is enablesAux(4);                           --  Enable Divisor
    alias sumador: std_logic_vector(1 downto 0) is enablesAux(6 downto 5);
...
begin
    ...
    C_DIVISOR: divisor port map (rst, clk, enable_divisor, clk_2Hz);
