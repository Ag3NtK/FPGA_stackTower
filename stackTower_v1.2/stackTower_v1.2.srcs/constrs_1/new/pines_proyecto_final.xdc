...
## Switches
set_property PACKAGE_PIN V17 [get_ports {sw_dificultad[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_dificultad[0]}]
set_property PACKAGE_PIN V16 [get_ports {sw_dificultad[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_dificultad[1]}]
...
set_property PACKAGE_PIN T17 [get_ports boton_jugar]						
	set_property IOSTANDARD LVCMOS33 [get_ports boton_jugar]
set_property PACKAGE_PIN U17 [get_ports boton_inicio]						
