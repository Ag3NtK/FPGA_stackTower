...
HD_PWD='C:/Trabajo/Final de TOC/FPGA_stackTower-main/FPGA_stackTower-main/stackTower_v2/stackTower_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sintesis_stackTower.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sintesis_stackTower.tcl
