    ...
    begin
        if (rst='1') then
            ...
            if dificultad = "00" then
                if (cuenta_dificultad="0001011111010111100001000000") then 
                ...
                if (cuenta_dificultad="0000101111101011110000100000") then 
                    clk_dificultad_aux <= '1';
                    cuenta_dificultad<= (others =>'0');
                else
                    cuenta_dificultad <= cuenta_dificultad+'1';
                ...
                if (cuenta_dificultad="0000010111110101111000010000") then 
                    clk_dificultad_aux <= '1';
                    cuenta_dificultad<= (others =>'0');
                else
                    cuenta_dificultad <= cuenta_dificultad+'1';
                ...
                if (cuenta_dificultad="0000001011111010111100001000") then 
                    clk_dificultad_aux <= '1';
                    cuenta_dificultad<= (others =>'0');
                else
                    cuenta_dificultad <= cuenta_dificultad+'1';
